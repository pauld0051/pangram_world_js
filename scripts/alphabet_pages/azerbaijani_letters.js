document.addEventListener("DOMContentLoaded", function () {
  const azSpecial = [
    { letter: "Ə", unicode: "Ə", name: "Schwa", id: "special-schwa-upper" },
    { letter: "ə", unicode: "ə", name: "schwa", id: "special-schwa-lower" },
  ...
  const azUppercase = [
    ...
    { letter: "Ə", unicode: "Ə", name: "Schwa", id: "upper-schwa" },
  ...
  const azLowercase = [
    ...
    { letter: "ə", unicode: "ə", name: "schwa", id: "lower-schwa" },
  ...
  createKeys("az-special-container", azSpecial);
  createKeys("az-i-container", azIForms);
  createKeys("az-uppercase-container", azUppercase);
  createKeys("az-lowercase-container", azLowercase);
});
